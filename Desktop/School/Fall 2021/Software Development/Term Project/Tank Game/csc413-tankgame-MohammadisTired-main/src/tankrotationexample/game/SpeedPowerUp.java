...
public class SpeedPowerUp {
    ...
    public SpeedPowerUp(int x, int y, BufferedImage superPowerUp) {
        this.x = x;
        this.y = y;
        this.speedPowerUp = superPowerUp;
        this.hitBox = new Rectangle(x,y,this.speedPowerUp.getWidth(),this.speedPowerUp.getHeight());
    }
    public Rectangle getHitBox() {
        return hitBox.getBounds();
    }
    ...
    public void drawImage(Graphics g){
        AffineTransform rotation = AffineTransform.getTranslateInstance(x, y);
        Graphics2D g2d = (Graphics2D) g;
        g2d.drawImage(this.speedPowerUp, rotation, null);
        g2d.setColor(Color.BLUE);
        g2d.drawRect(x,y, this.speedPowerUp.getWidth(),this.speedPowerUp.getHeight());
    }
}
