...
public class ShieldPowerUp {
    ...
    public ShieldPowerUp(int x, int y, BufferedImage shieldPowerUp) {
        this.x = x;
        this.y = y;
        this.shieldPowerUp = shieldPowerUp;
        this.hitBox = new Rectangle(x,y,this.shieldPowerUp.getWidth(),this.shieldPowerUp.getHeight());
    }
    public Rectangle getHitBox() {
        return hitBox.getBounds();
    }
    ...
    public void drawImage(Graphics g){
        AffineTransform rotation = AffineTransform.getTranslateInstance(x, y);
        Graphics2D g2d = (Graphics2D) g;
        g2d.drawImage(this.shieldPowerUp, rotation, null);
        g2d.setColor(Color.BLUE);
        g2d.drawRect(x,y, this.shieldPowerUp.getWidth(),this.shieldPowerUp.getHeight());
    }
}
